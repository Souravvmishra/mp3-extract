        ...
        <Card className="w-full max-w-2xl">
            <CardContent className="p-6">
                ...
                <Button
                    ...
                    className="w-full mt-6  hover: disabled:opacity-50"
                >
                    Next Question
                </Button>
            </CardContent>
...
const ResultScreen: React.FC<ResultScreenProps> = ({ responses, score, total, onRetry }) => {
    const router = useRouter();
    return (
        <motion.div
            initial={{ opacity: 0 }}
        ...
        >
            <Card className="w-full max-w-2xl">
                <CardContent className="p-6">
                    ...
                    <Button onClick={onRetry} className="w-full  hover:">
                        Try Again
                    </Button>
                    <Button variant={'outline'} onClick={() => router.push('/quadrat/result')} className="w-full ">
                        Report
