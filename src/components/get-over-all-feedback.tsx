...
const GetOverallFeedbackButton: React.FC = () => {
    ...
    const handleGenerateFeedback = async () => {
        ...
        try {
            const url = new URL('https://ak0601-feedback-api.hf.space/get_overall_feedback');
        ...
        <div className="my-4">
            ...
            <Dialog open={open} onOpenChange={setOpen}>
                <DialogContent className="max-w-3xl h-[80vh]">
                    <DialogHeader>
                        <DialogTitle className="text-xl font-semibold">Overall Performance Analysis</DialogTitle>
                    </DialogHeader>
...
export default GetOverallFeedbackButton;
